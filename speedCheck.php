...
<div class="read_and_type_the_passage2">
    <section class="test-area2">
        ...
        <div class="test-wrapper1">
            <textarea id="test-area2" onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off onkeyup="javascript:keypress('two')" name="textarea2" rows="9" cols="66" placeholder="Enter your password"></textarea>
        </div><!-- .test-wrapper -->
...
<div class="read_and_type_the_passage3">
    <section class = "test-area3">
        ...
        <div class="test-wrapper1">
            <textarea id="test-area3"  onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off onkeyup="javascript:keypress('three')" name="textarea3" rows="7" cols="66" placeholder="Enter your password"></textarea>
        </div><!-- .test-wrapper -->
    </section></div>
...
<div class="read_and_type_the_passage4">
    <section class = "test-area4">
        ...
        <div class="test-wrapper1">
            <textarea id="test-area4"  onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off onkeyup="javascript:keypress('four')" name="textarea4" rows="7" cols="66" placeholder="Enter your password"></textarea>
        </div><!-- .test-wrapper -->
    </section></div>
...
<hr>
    ...
    <div class="read_and_type_the_passage3">
        <section class = "test-area3">
            ...
            <div class="test-wrapper1">
                <textarea id="test-area4"  onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off onkeyup="javascript:keypress('five')" name="textarea5" rows="7" cols="66" placeholder="Enter your password"></textarea>
            </div><!-- .test-wrapper -->
        </section></div>
    ...
    <div class="read_and_type_the_passage3">
        <section class = "test-area3">
            ...
            <div class="test-wrapper1">
                <textarea id="test-area4" onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off onkeyup="javascript:keypress('six')"  name="textarea6" rows="7" cols="66" placeholder="Enter your password"></textarea>
            </div><!-- .test-wrapper -->
        </section></div>
